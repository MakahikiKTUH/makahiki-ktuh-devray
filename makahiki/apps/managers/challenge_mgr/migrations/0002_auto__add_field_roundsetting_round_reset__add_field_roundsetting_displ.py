...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('challenge_mgr_roundsetting', 'round_reset', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'RoundSetting.display_scoreboard'
        db.add_column('challenge_mgr_roundsetting', 'display_scoreboard', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RoundSetting.round_reset'
        db.delete_column('challenge_mgr_roundsetting', 'round_reset')

        # Deleting field 'RoundSetting.display_scoreboard'
        db.delete_column('challenge_mgr_roundsetting', 'display_scoreboard')
    ...
    models = {
        'challenge_mgr.challengesetting': {
            ...
            'theme': ('django.db.models.fields.CharField', [], {'default': "'theme-ktuh'", 'max_length': '50'}),
        ...
        'challenge_mgr.roundsetting': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 4, 15, 55, 50, 759786)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 27, 15, 55, 50, 759731)'})
        },
